...
const About = () => {
  ...
  const stats = [
    ...
    },
    {
      name: 'BACKEND',
      level: 8,
      skills: ['Node.js', 'Python', 'Flask', 'Express'],
    },
    {
      name: 'MOBILE',
      level: 7,
      skills: ['Flutter', 'Dart', 'Mobile-First Design'],
    },
  ...
  const specialTraits = [
    {
      icon: '🐛',
      label: 'Bug Hunter',
      description: 'Obsessed with clean code and squashing bugs',
    },
    {
      icon: '☕',
      label: '2am Coder',
      description: 'Peak productivity happens at 2am with espresso',
    },
    {
      icon: '🥔',
      label: 'Potato Tester',
      description: 'Tests on low-end hardware for maximum compatibility',
    },
    {
      icon: '🎮',
      label: 'Gaming Roots',
      description: 'Gaming since Windows XP, problem-solving in DNA',
    },
    {
      icon: '💻',
      label: 'Serial Committer',
      description: 'Commits more often than blinking',
    },
    {
      icon: '🚀',
      label: 'Full-Stack',
      description: 'Database to UI, nothing left behind',
    },
  ];
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="font-mono text-sm text-[var(--text-secondary)] max-w-2xl mx-auto">
            Level 24 Developer | Quest Completion Rate: 94% | Experience: 6
            Years
          </p>
        </div>
        ...
        >
          ...
          <div className="lg:col-span-1">
            <Card className="text-center">
              ...
              <div className="mb-6 mx-auto w-48 h-48 bg-[var(--accent)] bg-opacity-20 border-4 border-[var(--border)] pixel-corners flex items-center justify-center relative overflow-hidden">
                ...
                <div className="absolute bottom-2 right-2">
                  <div className="flex gap-1">
                    ...
                    <div
                      className="w-2 h-2 bg-[var(--success)] animate-pulse"
              ...
              <h3 className="font-pixel text-lg text-[var(--text-primary)] mb-2">
                SALIM MTIRI
              </h3>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <p className="font-mono text-sm text-[var(--text-secondary)] leading-relaxed mb-4">
                Gaming since Windows XP, coding since Pascal. Started with
                simple scripts and never looked back. Now building complete
                applications from database architecture to pixel-perfect UIs.
              </p>
              <p className="font-mono text-sm text-[var(--text-secondary)] leading-relaxed">
                Bug hunter by nature—if it works but looks ugly, it doesn't
                work. Tests every project on potato laptops because if it runs
                there, it runs anywhere. Peak productivity? 2am with espresso.
                Commits more often than blinking. Currently seeking a 6-month
                internship to level up and ship real-world products.
              </p>
            </Card>
        ...
        <div
          ref={traitsRef}
          className={`mb-12 ${traitsVisible ? 'scroll-visible' : 'scroll-hidden'}`}
        >
          <h3 className="font-pixel text-sm text-[var(--accent)] mb-6 text-center">
            {'> SPECIAL_TRAITS'}
          </h3>
            ...
            {specialTraits.map((trait, index) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-pixel text-[10px] text-[var(--accent)] mb-1">
                      {trait.label}
                    </h4>
        ...
        <div
          ref={eduRef}
          className={eduVisible ? 'scroll-visible' : 'scroll-hidden'}
        >
          <h3 className="font-pixel text-sm text-[var(--accent)] mb-6 text-center">
            {'> EDUCATION'}
          </h3>
            ...
            {education.map((edu, index) => (
              <Card key={index}>
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="font-pixel text-xs text-[var(--text-primary)] mb-1">
                      {edu.institution}
                    </h4>
