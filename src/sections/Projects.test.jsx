...
describe('Projects Section', () => {
  describe('Rendering', () => {
    ...
    it('should render section description', () => {
      ...
      expect(screen.getByText(/A collection of projects showcasing full-stack development/i)).toBeInTheDocument()
    })
    ...
    it('should render call to action section', () => {
      ...
      expect(screen.getByText(/Check back soon for more projects!/i)).toBeInTheDocument()
    })
  })
  ...
  describe('Filter Functionality', () => {
    it('should highlight "All Quests" filter by default', () => {
      ...
      const allQuestsButton = screen.getByRole('button', { name: /all quests/i })
    ...
    it('should return to all projects when "All Quests" clicked', async () => {
      ...
      // Click "All Quests"
      const allQuestsButton = screen.getByRole('button', { name: /⚔️ all quests/i })
  ...
  describe('Project Content', () => {
    it('should display project descriptions', () => {
      ...
      expect(screen.getByText(/Flutter-based gaming platform/i)).toBeInTheDocument()
      expect(screen.getByText(/Enterprise-grade ticketing system/i)).toBeInTheDocument()
    })
