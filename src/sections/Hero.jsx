  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        ></div>
        <div
          className="absolute bottom-1/3 left-1/3 w-4 h-4 bg-[var(--accent)] opacity-20 animate-float"
      ...
      <div className="container-custom text-center relative z-10">
        ...
        {/* Subtitle */}
        <div
          className={`transition-opacity duration-500 ${isTypingComplete ? 'opacity-100' : 'opacity-0'}`}
        >
          ...
          <p
            className="font-mono text-sm sm:text-base text-[var(--text-secondary)] mb-8 max-w-2xl mx-auto px-4 animate-fadeIn"
            style={{ animationDelay: '0.2s' }}
          >
            Gaming since Windows XP, coding since Pascal. Building complete
            applications from database to UI.
            <br className="hidden sm:block" />
            Bug hunter addict. Tests on potato laptops. Peak productivity at 2am
            with espresso.
          </p>
          ...
          {/* Status Badge */}
          <div
            className="mt-12 inline-flex items-center gap-3 px-6 py-3 bg-[var(--bg-secondary)] border-2 border-[var(--border)] pixel-corners animate-fadeIn"
