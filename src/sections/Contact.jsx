    ...
    <section id="contact" className="section-padding pb-40 mb-20">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <Card>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label
                    htmlFor="name"
                    className="font-mono text-xs text-[var(--text-primary)] mb-2 block"
                  >
                    Name *
                  </label>
                  <Input
          ...
          <div
            ref={infoRef}
            className={`space-y-6 ${infoVisible ? 'scroll-visible' : 'scroll-hidden'}`}
          >
            {/* Direct Contact Info */}
            <Card>
              <h3 className="font-pixel text-sm text-[var(--accent)] mb-6">
            ...
            <Card className="bg-[var(--accent)] bg-opacity-10 border-[var(--accent)]">
              <div className="text-center">
                ...
                <h3 className="font-pixel text-sm text-[var(--accent)] mb-2">
                  CURRENTLY SEEKING
                </h3>
