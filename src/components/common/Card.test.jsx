...
describe('Card Component', () => {
  describe('Rendering', () => {
    ...
    it('should render pixel corner decorations', () => {
      ...
      const corners = container.querySelectorAll('.absolute.w-2.h-2.bg-\\[var\\(--border\\)\\]')
  ...
  describe('Corner Decorations', () => {
    it('should position top-left corner correctly', () => {
      ...
      const topLeft = container.querySelector('.top-0.left-0.-translate-x-\\[3px\\].-translate-y-\\[3px\\]')
    ...
    it('should position top-right corner correctly', () => {
      ...
      const topRight = container.querySelector('.top-0.right-0.translate-x-\\[3px\\].-translate-y-\\[3px\\]')
    ...
    it('should position bottom-left corner correctly', () => {
      ...
      const bottomLeft = container.querySelector('.bottom-0.left-0.-translate-x-\\[3px\\].translate-y-\\[3px\\]')
    ...
    it('should position bottom-right corner correctly', () => {
      ...
      const bottomRight = container.querySelector('.bottom-0.right-0.translate-x-\\[3px\\].translate-y-\\[3px\\]')
