...
describe('ProjectCard Component', () => {
  ...
  describe('Category Icon', () => {
    it('should display gaming icon for gaming category', () => {
      ...
      const { container } = renderWithProviders(<ProjectCard project={gamingProject} />)
      expect(container.textContent).toContain('🎮')
    })

    it('should display web icon for web category', () => {
      const webProject = { ...mockProject, categories: ['web'] }
      const { container } = renderWithProviders(<ProjectCard project={webProject} />)
    ...
    it('should display mobile icon for mobile category', () => {
      ...
      const { container } = renderWithProviders(<ProjectCard project={mobileProject} />)
    ...
    it('should display enterprise icon for enterprise category', () => {
      ...
      const { container } = renderWithProviders(<ProjectCard project={enterpriseProject} />)
    ...
    it('should display AI icon for ai category', () => {
      ...
      const { container } = renderWithProviders(<ProjectCard project={aiProject} />)
    ...
    it('should display default icon for unknown category', () => {
      ...
      const { container } = renderWithProviders(<ProjectCard project={unknownProject} />)
  ...
  describe('Action Buttons', () => {
    ...
    it('should open githubUrl in new tab when Code button clicked', async () => {
      ...
      expect(window.open).toHaveBeenCalledWith('https://github.com/test/project', '_blank')
    })
  })

  describe('Image Display', () => {
    it('should display image placeholder when image is true', () => {
      const { container } = renderWithProviders(<ProjectCard project={mockProject} />)
    ...
    it('should not display image placeholder when image is false', () => {
      ...
      const { container } = renderWithProviders(<ProjectCard project={noImageProject} />)
