...
const Card = ({
  ...
  const baseClasses =
    'pixel-card border-3 border-[var(--border)] bg-[var(--bg-secondary)] p-6 relative transition-all duration-100';
  const hoverClasses = hoverable
    ? 'hover:transform hover:-translate-y-1 hover:shadow-[8px_8px_0_var(--border)]'
    : '';
